...
namespace ApiProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
                //var settings = Configuration.GetSection(nameof(MongoDBSettings)).Get<MongoDatabaseSettings>();
                //return new MongoClient(settings.ConnectionString);
            //}
            //);

            services.AddSingleton<ILocalAndExternalRepo, LocalMemoryItemsRepo>(); // Register the dependency
